...
- `docs/engine/architecture/ROADMAP_ENGINE_CPP_AMIGA500.md`
- `docs/build/BUILD_AND_RUN.md`
- `docs/engine/architecture/CODING_STYLE.md`
- `docs/engine/architecture/MEMORY_MODEL.md`
- `docs/engine/architecture/GRAPHICS_DRIVERS.md`
...
- Se ha indexado `C:\Users\David\Documents\Programa\Amiga\demoscene-repo` en
  `docs/demos/effects/DEMOSCENE_REPO_INDEX.md`. Hallazgos clave: `effects/tiles16` combina dirty
...
- Se ha fijado `docs/demos/effects/DEMOSCENE_EFFECT_REPLICATION_POLICY.md`: las replicas de
...
- Se ha creado `docs/engine/architecture/RETRO_ENGINE_API_BENCHMARK.md`, con aprendizajes de ACE,
