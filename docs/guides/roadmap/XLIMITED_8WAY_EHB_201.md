...
> `docs/guides/roadmap/ROADMAP_UNIFICADO.md`; no usar este fichero como guía de trabajo
...
> `out/assets/ehb/tilebank.raw.bin` (1149 tiles × 256 B) a `out/assets/ehb/tilebank.xlimited.bin`
