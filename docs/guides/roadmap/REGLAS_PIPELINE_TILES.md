...
> `docs/demos/tile-pipeline/PIPELINE_TILES_EHB.md`. Este fichero es el resumen de las invariantes.
...
slice-tiles.mjs <origen>.png --palette out/assets/ehb/palette.json [--ehb-merge F]
...
(`out/assets/ehb/tilebank.raw.bin`, `out/assets/ehb/const_game_201.h`). Desde esta fecha el reindexado a
