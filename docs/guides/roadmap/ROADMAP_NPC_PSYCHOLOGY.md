...
| P6.5 | `docs/debugging/investigaciones/npc-table-scenarios.md` | Escenarios de mesa: pardillo, listillo, observador que aprende, irascible en tilt, humano lento | Hecho |
