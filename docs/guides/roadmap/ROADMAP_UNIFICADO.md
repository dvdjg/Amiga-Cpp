...
- **Ecosistema vivo (`eng::sim`) — modelo base entregado** y verificado por test host:
  ...
  **rumores/memoria de grupo**, sociedad/enjambre (HOST-152…154, HOST-156…170),
  ...
  **biomas/ecosistemas** (HOST-169) y **lenguaje/gestos** atados a emoción y jerarquía
  (HOST-170), y **planificación GOAP integrada** con dominio de construcción (HOST-155), con
  gate de codegen 68000. Reutiliza `eng::ai` (utility, percepción, navegación, steering,
  GOAP). Falta consumidor en demo/juego y las líneas de crecimiento (percepción imperfecta,
  cultura/rituales, coordinación de manadas). Detalle:
