...
| `docs/guides/roadmap/ROADMAP_BOARD_GAMES.md` | **vigente (B0 y B1.1–B1.2 hechos)** | Motores de tablero (`eng::board`): ajedrez y Go 9×9 con footprint 20 kB–1 MB, conocimiento en disquete y explicación NLG ES/EN; núcleo + reglas de ajedrez verificados (HOST-137…140); diseño en `docs/engine/architecture/BOARD_GAME_AI.md` y concurrencia en `docs/engine/architecture/PARALLEL_AND_THREADS.md` |
