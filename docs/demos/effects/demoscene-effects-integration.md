...
Para que la mayoría de efectos se adapten con pocos cambios (alineado con [techniques/README.md](../../reference/amiga/techniques/README.md) y [amiga-chipset-matrix.md](../../reference/amiga/hardware/amiga-chipset-matrix.md)):
