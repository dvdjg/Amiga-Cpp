...
- **Handshake (engine, `engine/src/platform/amiga_minimal/amiga_minimal_os.cpp`)**: `os_kbd_isr` pulsa
...
- Engine: `engine/src/platform/amiga_minimal/amiga_minimal_os.cpp` (`os_kbd_isr`, `enable_keyboard`).
