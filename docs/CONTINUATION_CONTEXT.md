...
11. `demos/techniques/amiga/setup/000_toolchain_cpp23/README.md`
...
- superar su analizador especifico `demos\techniques\amiga\copper\020_copper_basic\analyze-screenshot.ps1`.
...
- superar su analizador especifico `demos\techniques\amiga\copper\030_ehb_palette_zones\analyze-screenshot.ps1`.
...
- superar `demos\techniques\amiga\effects\040_palette_cycle_effect\analyze-screenshot.ps1`;
...
- superar `demos\techniques\amiga\blitter\050_blitter_bobs\analyze-screenshot.ps1`;
...
- superar `demos\techniques\amiga\blitter\051_blitter_shifted_bobs\analyze-screenshot.ps1`;
...
- superar `demos\techniques\amiga\blitter\052_tile_staging_blits\analyze-screenshot.ps1`;
...
- superar `demos\techniques\amiga\playfield\100_virtual_tile_scene_scroll\analyze-screenshot.ps1`;
...
- superar `demos\techniques\amiga\playfield\101_ehb_tile_scroll_driver\analyze-screenshot.ps1`;
...
```powershell
.\tools\run\run-demo.ps1 demos\techniques\amiga\playfield\101_ehb_tile_scroll_driver -SequenceFrames 4 -SequenceIntervalMs 80
...
```powershell
.\demos\techniques\amiga\playfield\101_ehb_tile_scroll_driver\analyze-sequence.ps1 -Warp
```
...
```powershell
.\demos\techniques\amiga\playfield\101_ehb_tile_scroll_driver\analyze-sequence.ps1 -Warp -RequireVisionReviewOk
```
...
- `analyze-sequence.ps1 -Warp`: ok con 12 frames, FrameScope y detector de negro
  interno.
- `tools/test-regression.ps1 -Demo demos\techniques\amiga\playfield\101_ehb_tile_scroll_driver -Warp`: ok,
...
- `demos\techniques\amiga\playfield\101_ehb_tile_scroll_driver\analyze-fine-scroll.sh` captura y valida:
