...
| [PLAYFIELD_SCROLL_ARCHITECTURE.md](PLAYFIELD_SCROLL_ARCHITECTURE.md) | **Modelo objetivo** de playfields y scroll: separación algoritmo ↔ superficie ↔ composición ↔ mapping Amiga (`PlanarPlayfield<N>`, `PlaneViewPlayfield`, estrategias, `DisplayComposition`). Contrato de refactor. |
