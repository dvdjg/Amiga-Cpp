...
existente en `engine/src/platform/amiga_minimal/amiga_minimal.cpp`
...
- `engine/src/platform/amiga_minimal/amiga_minimal.cpp` (`install_timer_service`, Timer A continuo).
