...
> `docs/debugging/investigaciones/106_sesion-tilefield.md` y `docs/engine/architecture/CIRCULAR_VS_XLIMITED.md`.
>
...
> infinito. Ver comparativa completa en `docs/engine/architecture/CIRCULAR_VS_XLIMITED.md`
...
`demos/amiga/106_tile_field_showcase` cubre dual 3+3 y single de 5 planos. Las
