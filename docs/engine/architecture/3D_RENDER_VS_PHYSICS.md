...
```
   ...
   object3d/lib3d (mesh obj)          mesh3d: mesh_painter_order
```
...
| Malla (render) | `eng/core/mesh3d.hpp` | `MeshView` (vértices + caras triangulares), `Vec3`, `mesh_transform`, culling y orden painter |
