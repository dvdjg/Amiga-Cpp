...
Documento maestro para implementar **tests reproducibles** (código + capturas + notas), alineado con el MCP WinUAE, el engine y las fichas de [techniques/README.md](../../reference/amiga/techniques/README.md). Las entradas marcadas **(plan)** aún no tienen carpeta en el repo: sirven como **backlog priorizado** para la IA y el desarrollador.
...
| **T08** | Modulo tricks (skew / ventana) | Patrón que demuestra `BPL1MOD`/`BPL2MOD` ≠ ancho nominal | Módulos, `DDF` | A500 | (plan) — enlazar [modulo-tricks.md](../../reference/amiga/techniques/modulo-tricks.md) |
...
| **C05** | Copper “chunky” por bloques | Bloques de color simulando baja resolución horizontal | Copper denso | A500 | (plan) — [copper-chunky.md](../../reference/amiga/techniques/copper-chunky.md) |
...
| **B07** | Blitter **asistido por CPU** (bandas) | CPU y blitter en paralelo en regiones distintas | `DMACON`, `BBUSY` | A1200 preferente | (plan) — [cpu-blit-assist.md](../../reference/amiga/techniques/cpu-blit-assist.md) |
...
| **S04** | **BOBs** (blitter objects) | Objetos movidos con restauración de fondo o dual playfield | Blitter + [dual-playfield-fastbobs.md](../../reference/amiga/techniques/dual-playfield-fastbobs.md) | A500 | (plan) |
...
| **A03** | Mezcla software ligera para juego | Buffer mezclado + reproducción (si aplica) | CPU + Paula | A500+ | (plan) — [audio-mixing.md](../../reference/amiga/techniques/audio-mixing.md) |
