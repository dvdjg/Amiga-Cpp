...
**Síntoma**: con `demos/techniques/amiga/playfield/107_xlimited_corkscrew/src/main.cpp`, pulsar F5 mostraba "otra
...
- Si el archivo activo no es `demos/<demo>/src`, error explícito con la guía
  "abre y enfoca demos/techniques/amiga/playfield/107_xlimited_corkscrew/src/main.cpp" y `session.json` con
