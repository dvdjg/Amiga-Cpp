...
| Texto / UI | 09-textscroll, 27-credits, 37-gui | Texto vía API: `Surface::draw_text` (`eng/field/surface.hpp`, UTF-8) + `Font8` (LATIN-1, `eng/graphics/font8.hpp`); decodificador `eng/core/utf8.hpp`; fuente 5x7 de HUD en la demo 201. Regla: no reimplementar `draw_text` — usar estas utilidades. |
