...
| **Blitter / BOBs / minterms / líneas** | [DEMOSCENE_REPO_INDEX.md](../demos/effects/DEMOSCENE_REPO_INDEX.md) (blitter interleaved), técnicas `dual-playfield-fastbobs.md`, `blitter-line-subpixel-fill.md` (líneas + rasterizado sub-píxel), AHRM cap. 6 | demos 050, 051, 052, 079, 116, 200s |
