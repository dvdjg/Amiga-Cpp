...
| [engine/](engine/README.md) | Diseño del engine C++ actual: estilo, drivers gráficos, memoria, política de hardware/ROM, benchmarks de API, IA de juego (`engine/architecture/GAME_AI_LIBRARY.md`), ecosistema vivo (`engine/architecture/SIM_ECOSYSTEM.md`), perfil psicológico de NPC (`engine/architecture/NPC_PSYCHOLOGY.md`), motores de tablero (`engine/architecture/BOARD_GAME_AI.md`), motores de naipes (`engine/architecture/CARD_GAME_AI.md`), inventario de hardware (`engine/architecture/HARDWARE_INVENTORY.md`), concurrencia abstracta (`engine/architecture/PARALLEL_AND_THREADS.md`), mini-SO de mensajes (`engine/architecture/MINI_OS_MESSAGE_LOOP.md` + `MINI_OS_INPUT.md`/`MINI_OS_TIME.md`/`MINI_OS_IO.md`/`MINI_OS_TASKS.md`), recursos (`engine/architecture/RESOURCE_SYSTEM.md`), audio (`engine/architecture/GAME_AUDIO.md` + `AUDIO_STREAMING.md`), librería GUI (`engine/architecture/GUI_LIBRARY.md`), revisión de estructura y decisiones (`engine/architecture/ENGINE_STRUCTURE_REVIEW.md`), capas de plataforma y contrato de backend (`engine/architecture/PLATFORM_LAYERS.md`), política de cabeceras (`engine/architecture/HEADER_POLICY.md`) y roadmap (en `engine/architecture/`) + histórico del engine C (`engine/c-engine/`). |
...
| [reference/](reference/README.md) | Referencia por plataforma: `reference/amiga/` (hardware + técnicas), `reference/ahrm/` (AHRM 3.ª edición), `reference/amc-wrobel/`, `reference/emulators/` (rarezas del emulador, con `fichero:línea`), y áreas futuras `atarist/` y `megadrive/`. |
| [guides/](guides/README.md) | Roadmaps vigentes (`guides/roadmap/`, p. ej. [ROADMAP_GAME_AI.md](guides/roadmap/ROADMAP_GAME_AI.md) para IA y diseño de juego, [ROADMAP_BOARD_GAMES.md](guides/roadmap/ROADMAP_BOARD_GAMES.md) para motores de tablero, [ROADMAP_CARD_GAMES.md](guides/roadmap/ROADMAP_CARD_GAMES.md) para motores de naipes, [ROADMAP_NPC_PSYCHOLOGY.md](guides/roadmap/ROADMAP_NPC_PSYCHOLOGY.md) para el perfil psicológico de NPC [REFACTOR_SCALAR_GENERICO.md](guides/roadmap/REFACTOR_SCALAR_GENERICO.md) para el escalar genérico 16/32/64 bits y [ROADMAP_WORKBENCH.md](guides/roadmap/ROADMAP_WORKBENCH.md) para la UI portable engine⟷Workbench y [ROADMAP_RASTER_ROAD.md](guides/roadmap/ROADMAP_RASTER_ROAD.md) para carretera/suelo por raster y [ROADMAP_HW_ZOOM.md](guides/roadmap/ROADMAP_HW_ZOOM.md) para zoom hardware y [ROADMAP_PROCEDURAL_WORLDS.md](guides/roadmap/ROADMAP_PROCEDURAL_WORLDS.md) para generación procedural de mundos metroidvania), guías de optimización (`guides/optimization/`) y metodología/agentes (`guides/methodology/`). Estado vigente en [ROADMAP_UNIFICADO.md](guides/roadmap/ROADMAP_UNIFICADO.md); bitácora histórica del scroll por tiles en [BITACORA_SCROLL_TILES.md](guides/roadmap/BITACORA_SCROLL_TILES.md); plan de organización del engine/tests en [PLAN_ORGANIZACION_ENGINE.md](guides/roadmap/PLAN_ORGANIZACION_ENGINE.md) y de las demos en [PLAN_ORGANIZACION_DEMOS.md](guides/roadmap/PLAN_ORGANIZACION_DEMOS.md). |
...
| [debugging/](debugging/README.md) | Depuración: `system/` (sistema WinUAE-DBG: arquitectura, arreglos, entorno) e `investigaciones/` (bloqueos abiertos, post-mortems, consultas). |
| [testing/](testing/README.md) | Validación: pixel assertions, secuencias de frames, FrameScope y Vision Review; taxonomía de tests por plataforma/nivel/categoría ([TAXONOMY.md](testing/TAXONOMY.md)). |
...
- **ACE (Amiga C Engine)** — referencia de decodificación del joystick
  (`eng/platform/amiga/input_poll.hpp`).
