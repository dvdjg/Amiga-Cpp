...
AMIGA_BIN_PATH=C:/Users/dvdjg/Documents/programa/AI/Amiga/vscode-amiga-debug/bin/win32 \
  bash ./tools/build/build-demo.sh demos/amiga/105_tile_scroll_xyunlimited_dualpf --debug --clean
bash ./tools/run/run-demo.sh demos/amiga/105_tile_scroll_xyunlimited_dualpf --sequence-frames 720
bash ./tools/analyze/analyze-demo.sh demos/amiga/105_tile_scroll_xyunlimited_dualpf
bash ./demos/amiga/105_tile_scroll_xyunlimited_dualpf/analyze-sequence.sh
```
