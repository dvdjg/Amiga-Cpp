...
```powershell
.\tools\build\build-demo.ps1 demos\amiga\100_virtual_tile_scene_scroll -DebugBuild
.\tools\run\run-demo.ps1 demos\amiga\100_virtual_tile_scene_scroll
.\tools\analyze\analyze-demo.ps1 demos\amiga\100_virtual_tile_scene_scroll
```
