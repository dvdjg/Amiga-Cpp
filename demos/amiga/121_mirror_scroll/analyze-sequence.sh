...
#   bash demos/amiga/121_mirror_scroll/analyze-sequence.sh [--warp] [--config A500_debug]
#
...
bash ./tools/build/build-demo.sh demos/amiga/121_mirror_scroll --"$MODE" --clean >/dev/null

echo "[121] run + secuencia..."
bash ./tools/run/run-demo.sh demos/amiga/121_mirror_scroll --config "$CONFIG" \
