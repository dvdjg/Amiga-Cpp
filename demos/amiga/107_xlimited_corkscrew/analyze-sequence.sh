...
#
# Uso: bash demos/amiga/107_xlimited_corkscrew/analyze-sequence.sh [--warp] [--release]
...
DEMO="demos/amiga/107_xlimited_corkscrew"
...
#    Ver demos/amiga/107_xlimited_corkscrew/src/main.cpp:317. Se valida frame>=80,
