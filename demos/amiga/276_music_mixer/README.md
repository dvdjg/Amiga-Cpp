...
```bash
EXTRA_DEFINES='-DMED_FROM_DISK="data/audio/SneakyChick.mod"' bash tools/build/build-demo.sh demos/amiga/276_music_mixer --debug
...
WINUAE_GDB_PORT=2355 WINUAE_SIDE_CHANNEL_PORT=2421 bash tools/run/run-demo.sh demos/amiga/276_music_mixer --config "$CFG"
```
