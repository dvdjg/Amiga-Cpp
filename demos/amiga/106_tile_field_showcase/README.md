...
AMIGA_BIN_PATH="..." bash ./tools/build/build-demo.sh demos/amiga/106_tile_field_showcase --debug --clean
...
- **Análisis visual**: `bash ./demos/amiga/106_tile_field_showcase/analyze-sequence.sh --warp`
...
- Arquitectura de la API: `docs/engine/architecture/TILE_FIELD_API.md`.
- Notas de sesión y bugs resueltos: `docs/debugging/106_SESION_TILEFIELD.md`.
- Modelo circular 8-way: `docs/engine/architecture/AMIGA_8WAY_SCROLLING.md`.
