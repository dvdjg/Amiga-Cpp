...
// Detalles, invariantes y esquemas: `docs/engine/architecture/AMIGA_8WAY_SCROLLING.md`.
...
///
/// Referencia didáctica: docs/engine/architecture/AMIGA_8WAY_SCROLLING.md explica la
