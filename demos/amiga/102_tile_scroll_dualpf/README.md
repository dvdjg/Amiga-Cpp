...
```bash
bash ./tools/build/build-demo.sh demos/amiga/102_tile_scroll_dualpf --debug --clean
bash ./tools/run/run-demo.sh demos/amiga/102_tile_scroll_dualpf --sequence-frames 8 --sequence-interval-ms 150
bash ./demos/amiga/102_tile_scroll_dualpf/analyze-sequence.sh --warp
```
...
`docs/engine/architecture/TILE_FIELD_API.md`.
