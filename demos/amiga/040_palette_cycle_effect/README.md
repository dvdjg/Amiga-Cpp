...
```powershell
.\tools\build\build-demo.ps1 demos\amiga\040_palette_cycle_effect -DebugBuild
.\tools\run\run-demo.ps1 demos\amiga\040_palette_cycle_effect
.\tools\analyze\analyze-demo.ps1 demos\amiga\040_palette_cycle_effect
```
