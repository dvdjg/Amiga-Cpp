...
#   bash demos/amiga/122_doublebuffer_scroll/analyze-sequence.sh [--warp] [--config A500_debug]
#
...
bash ./tools/build/build-demo.sh demos/amiga/122_doublebuffer_scroll --"$MODE" --clean >/dev/null

echo "[122] run + secuencia..."
bash ./tools/run/run-demo.sh demos/amiga/122_doublebuffer_scroll --config "$CONFIG" \
