...
```bash
bash ./tools/build/build-demo.sh demos/amiga/122_doublebuffer_scroll --debug --clean
bash ./tools/run/run-demo.sh demos/amiga/122_doublebuffer_scroll
bash ./demos/amiga/122_doublebuffer_scroll/analyze-sequence.sh [--warp]
```
