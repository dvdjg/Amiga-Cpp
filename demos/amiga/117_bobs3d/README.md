...
EXTRA_DEFINES="-DK_117_MAXBLOBS=60"          bash ./tools/build/build-demo.sh demos/amiga/117_bobs3d --debug  # 60 BOBs (fiel, ~20 fps)
EXTRA_DEFINES="-DK_117_IRQ=1"                bash ./tools/build/build-demo.sh demos/amiga/117_bobs3d --debug  # cadencia IRQ (requiere triple buffer)
EXTRA_DEFINES="-DK_117_PROF=0"               bash ./tools/build/build-demo.sh demos/amiga/117_bobs3d --debug  # sin instrumentacion
```
