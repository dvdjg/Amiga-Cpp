...
```
bash ./tools/build/build-demo.sh demos/amiga/202_xlimited_dpf --debug --clean
bash ./tools/run/run-demo.sh demos/amiga/202_xlimited_dpf            # screenshot
bash ./demos/amiga/202_xlimited_dpf/analyze-sequence.sh [--warp]      # parallax 2:1
bash ./demos/amiga/202_xlimited_dpf/analyze-sequence.sh --release
```
