...
try {
	...
	foreach ($name in @("skyBlue", "mountainPurple", "jungleGreen", "jungleLight", "ruinGold", "underWater", "whiteSpark")) {
	...
	if (($detail -band 0xff000000) -ne 0x10000000) {
		throw ("runStatus.detail no contiene la marca de la demo 100: 0x{0:x8}" -f $detail)
	}
