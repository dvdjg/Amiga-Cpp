...
```bash
bash ./tools/run/run-demo.sh demos/techniques/amiga/3d/084_mf_rotation --read-debugperiph counters
```
...
```bash
bash ./tools/build/build-demo.sh demos/techniques/amiga/3d/084_mf_rotation --debug --clean
bash ./tools/run/run-demo.sh demos/techniques/amiga/3d/084_mf_rotation
bash ./tools/analyze/analyze-demo.sh demos/techniques/amiga/3d/084_mf_rotation
```
