...
```powershell
.\tools\build\build-demo.ps1 demos\techniques\amiga\setup\010_chip_slow_memory -DebugBuild
.\tools\run\run-demo.ps1 demos\techniques\amiga\setup\010_chip_slow_memory
.\tools\analyze\analyze-demo.ps1 demos\techniques\amiga\setup\010_chip_slow_memory
```
