// Lanzar:
//   Depurar   : bash ./tools/build/build-demo.sh demos/techniques/amiga/c2p/061_c2p_chunky_4bpl --debug   && bash ./tools/run/run-demo.sh demos/techniques/amiga/c2p/061_c2p_chunky_4bpl --keep-running
//   Optimizada: bash ./tools/build/build-demo.sh demos/techniques/amiga/c2p/061_c2p_chunky_4bpl --release && bash ./tools/run/run-demo.sh demos/techniques/amiga/c2p/061_c2p_chunky_4bpl --keep-running
...
//   bash tools/build/build-demo.sh demos/techniques/amiga/c2p/061_c2p_chunky_4bpl --clean
//   <Node> dist/tools/run/run-demo.js demos/techniques/amiga/c2p/061_c2p_chunky_4bpl --warp
