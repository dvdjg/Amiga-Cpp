...
```bash
tools/build/build-demo.sh demos/techniques/amiga/c2p/061_c2p_chunky_4bpl --clean
tools/run/run-demo.sh       demos/techniques/amiga/c2p/061_c2p_chunky_4bpl
tools/analyze/analyze-demo.sh demos/techniques/amiga/c2p/061_c2p_chunky_4bpl
```
