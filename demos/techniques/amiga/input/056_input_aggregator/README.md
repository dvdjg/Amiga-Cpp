...
tools/build/build-demo.sh demos/techniques/amiga/input/056_input_aggregator --clean
tools/run/run-demo.sh       demos/techniques/amiga/input/056_input_aggregator
```
