...
```
bash ./tools/build/build-demo.sh demos/techniques/amiga/audio/217_audio_game_example --debug
bash ./tools/run/run-demo.sh demos/techniques/amiga/audio/217_audio_game_example --warp
```
