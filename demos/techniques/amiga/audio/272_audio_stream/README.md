...
```bash
bash tools/build/build-demo.sh demos/techniques/amiga/audio/272_audio_stream --debug
WINUAE_SIDE_CHANNEL_PORT=2421 bash tools/run/run-demo.sh demos/techniques/amiga/audio/272_audio_stream --warp --wait-port 300
```
