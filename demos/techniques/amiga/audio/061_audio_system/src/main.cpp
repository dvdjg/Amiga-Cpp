// Lanzar:
//   Depurar   : bash ./tools/build/build-demo.sh demos/techniques/amiga/audio/061_audio_system --debug   && bash ./tools/run/run-demo.sh demos/techniques/amiga/audio/061_audio_system --keep-running
//   Optimizada: bash ./tools/build/build-demo.sh demos/techniques/amiga/audio/061_audio_system --release && bash ./tools/run/run-demo.sh demos/techniques/amiga/audio/061_audio_system --keep-running
