#!/usr/bin/env bash
# Analizador visual de la demo 058 (sfx mixer): barra de volumen cian sobre fondo
...
if (cyan < 20) { console.error("FAIL audio: barra de volumen cian ausente (cyan=" + cyan + ")"); process.exit(1); }
