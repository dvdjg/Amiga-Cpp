...
#   bash demos/techniques/amiga/playfield/110_ylimited_shooter/analyze-sequence.sh [--warp] [--config A500_debug]
#
...
bash ./tools/build/build-demo.sh demos/techniques/amiga/playfield/110_ylimited_shooter --"$MODE" --clean >/dev/null

echo "[110] run + secuencia..."
bash ./tools/run/run-demo.sh demos/techniques/amiga/playfield/110_ylimited_shooter --config "$CONFIG" \
