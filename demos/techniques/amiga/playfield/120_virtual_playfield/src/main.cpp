// Lanzar:
//   Depurar   : bash ./tools/build/build-demo.sh demos/techniques/amiga/playfield/120_virtual_playfield --debug   && bash ./tools/run/run-demo.sh demos/techniques/amiga/playfield/120_virtual_playfield --keep-running
//   Optimizada: bash ./tools/build/build-demo.sh demos/techniques/amiga/playfield/120_virtual_playfield --release && bash ./tools/run/run-demo.sh demos/techniques/amiga/playfield/120_virtual_playfield --keep-running
