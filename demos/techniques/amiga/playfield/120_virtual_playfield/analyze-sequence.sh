...
#   bash demos/techniques/amiga/playfield/120_virtual_playfield/analyze-sequence.sh [--warp] [--config A500_debug]
#
...
bash ./tools/build/build-demo.sh demos/techniques/amiga/playfield/120_virtual_playfield --"$MODE" --clean >/dev/null

echo "[120] run + secuencia..."
bash ./tools/run/run-demo.sh demos/techniques/amiga/playfield/120_virtual_playfield --config "$CONFIG" \
