...
```bash
bash ./tools/build/build-demo.sh demos/techniques/amiga/playfield/120_virtual_playfield --debug --clean
bash ./tools/run/run-demo.sh demos/techniques/amiga/playfield/120_virtual_playfield
bash ./demos/techniques/amiga/playfield/120_virtual_playfield/analyze-sequence.sh [--warp]
```
