...
```bash
bash ./tools/build/build-demo.sh demos/techniques/amiga/playfield/121_mirror_scroll --debug --clean
bash ./tools/run/run-demo.sh demos/techniques/amiga/playfield/121_mirror_scroll
bash ./demos/techniques/amiga/playfield/121_mirror_scroll/analyze-sequence.sh [--warp]
```
