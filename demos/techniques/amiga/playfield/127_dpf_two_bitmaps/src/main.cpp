// Lanzar:
//   Depurar   : bash ./tools/build/build-demo.sh demos/techniques/amiga/playfield/127_dpf_two_bitmaps --debug   && bash ./tools/run/run-demo.sh demos/techniques/amiga/playfield/127_dpf_two_bitmaps --keep-running
//   Optimizada: bash ./tools/build/build-demo.sh demos/techniques/amiga/playfield/127_dpf_two_bitmaps --release && bash ./tools/run/run-demo.sh demos/techniques/amiga/playfield/127_dpf_two_bitmaps --keep-running
