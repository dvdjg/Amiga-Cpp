...
```powershell
.\tools\build\build-demo.ps1 demos\techniques\amiga\playfield\100_virtual_tile_scene_scroll -DebugBuild
.\tools\run\run-demo.ps1 demos\techniques\amiga\playfield\100_virtual_tile_scene_scroll
.\tools\analyze\analyze-demo.ps1 demos\techniques\amiga\playfield\100_virtual_tile_scene_scroll
```
