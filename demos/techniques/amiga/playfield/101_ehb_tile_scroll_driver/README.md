...
```bash
bash ./tools/build/build-demo.sh demos/techniques/amiga/playfield/101_ehb_tile_scroll_driver --debug --clean
bash ./tools/run/run-demo.sh demos/techniques/amiga/playfield/101_ehb_tile_scroll_driver
bash ./tools/analyze/analyze-demo.sh demos/techniques/amiga/playfield/101_ehb_tile_scroll_driver
bash ./tools/run/run-demo.sh demos/techniques/amiga/playfield/101_ehb_tile_scroll_driver --sequence-frames 4 --sequence-interval-ms 80
bash ./tools/analyze/analyze-frame-sequence.sh out/run/101_ehb_tile_scroll_driver/sequence --expect-animated
bash ./demos/techniques/amiga/playfield/101_ehb_tile_scroll_driver/analyze-sequence.sh --warp
```
...
```bash
bash ./tools/run/run-demo.sh demos/techniques/amiga/playfield/101_ehb_tile_scroll_driver --keep-running
```
