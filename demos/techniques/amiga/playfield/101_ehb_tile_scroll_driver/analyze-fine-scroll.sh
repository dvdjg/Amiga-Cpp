...
PY="$ROOT/dist/demos/techniques/amiga/playfield/101_ehb_tile_scroll_driver/analyze_fine_scroll.js"
...
if ! "$RUN" demos/techniques/amiga/playfield/101_ehb_tile_scroll_driver --settle-ms 0 \
