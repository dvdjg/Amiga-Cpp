...
# engine/include/eng/field/xlimited.hpp y docs/engine/architecture/AMIGA_8WAY_SCROLLING.md:
#
...
#
# Uso: bash demos/techniques/amiga/playfield/107_xlimited_corkscrew/analyze-sequence.sh [--warp] [--release]
...
DEMO="demos/techniques/amiga/playfield/107_xlimited_corkscrew"
...
#    Ver demos/techniques/amiga/playfield/107_xlimited_corkscrew/src/main.cpp:317. Se valida frame>=80,
