...
```bash
bash ./tools/build/build-demo.sh demos/techniques/amiga/playfield/113_mode_switch --debug --clean
bash ./tools/run/run-demo.sh demos/techniques/amiga/playfield/113_mode_switch
...
```bash
EXTRA_DEFINES="-DK_NO_MODE_SWITCH=1" bash ./tools/build/build-demo.sh demos/techniques/amiga/playfield/113_mode_switch --debug
bash ./tools/run/run-demo.sh demos/techniques/amiga/playfield/113_mode_switch --config A500_k_no_mode_switch1_debug
