// Lanzar:
//   Depurar   : bash ./tools/build/build-demo.sh demos/techniques/amiga/copper/020_copper_basic --debug   && bash ./tools/run/run-demo.sh demos/techniques/amiga/copper/020_copper_basic --keep-running
//   Optimizada: bash ./tools/build/build-demo.sh demos/techniques/amiga/copper/020_copper_basic --release && bash ./tools/run/run-demo.sh demos/techniques/amiga/copper/020_copper_basic --keep-running
