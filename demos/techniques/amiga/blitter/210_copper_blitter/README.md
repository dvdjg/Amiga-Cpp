...
```
   ...
   bash ./demos/techniques/amiga/blitter/210_copper_blitter/analyze-sequence.sh --warp
```
...
- **Host**: `tests/host/graphics/260_copper_blitter` (ventana segura) y `tests/host/graphics/267_fine_scroll`
