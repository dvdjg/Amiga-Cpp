...
```bash
bash ./tools/build/build-demo.sh demos/techniques/amiga/blitter/087_sprite_horizontal_rearm --debug --clean
bash ./tools/run/run-demo.sh demos/techniques/amiga/blitter/087_sprite_horizontal_rearm
```
