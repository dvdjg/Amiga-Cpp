...
```powershell
.\tools\build\build-demo.ps1 demos\techniques\amiga\blitter\052_tile_staging_blits -DebugBuild
.\tools\run\run-demo.ps1 demos\techniques\amiga\blitter\052_tile_staging_blits
.\tools\analyze\analyze-demo.ps1 demos\techniques\amiga\blitter\052_tile_staging_blits
```
