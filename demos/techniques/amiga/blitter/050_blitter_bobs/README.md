...
```powershell
.\tools\build\build-demo.ps1 demos\techniques\amiga\blitter\050_blitter_bobs -DebugBuild
.\tools\run\run-demo.ps1 demos\techniques\amiga\blitter\050_blitter_bobs
.\tools\analyze\analyze-demo.ps1 demos\techniques\amiga\blitter\050_blitter_bobs
```
