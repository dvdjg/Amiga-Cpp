// Lanzar:
//   Depurar   : bash ./tools/build/build-demo.sh demos/techniques/amiga/blitter/050_blitter_bobs --debug   && bash ./tools/run/run-demo.sh demos/techniques/amiga/blitter/050_blitter_bobs --keep-running
//   Optimizada: bash ./tools/build/build-demo.sh demos/techniques/amiga/blitter/050_blitter_bobs --release && bash ./tools/run/run-demo.sh demos/techniques/amiga/blitter/050_blitter_bobs --keep-running
