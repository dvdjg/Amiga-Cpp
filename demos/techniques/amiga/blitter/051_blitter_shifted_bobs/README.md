...
```powershell
.\tools\build\build-demo.ps1 demos\techniques\amiga\blitter\051_blitter_shifted_bobs -DebugBuild
.\tools\run\run-demo.ps1 demos\techniques\amiga\blitter\051_blitter_shifted_bobs
.\tools\analyze\analyze-demo.ps1 demos\techniques\amiga\blitter\051_blitter_shifted_bobs
```
