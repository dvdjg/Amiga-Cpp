...
```bash
bash ./tools/build/build-demo.sh demos/techniques/amiga/effects/116_flatshade_convex --debug --clean
bash ./tools/run/run-demo.sh demos/techniques/amiga/effects/116_flatshade_convex
