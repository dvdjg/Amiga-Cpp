...
```bash
bash ./tools/build/build-demo.sh demos/techniques/amiga/effects/083_fbm_noise --debug --clean
bash ./tools/run/run-demo.sh demos/techniques/amiga/effects/083_fbm_noise
bash ./tools/analyze/analyze-demo.sh demos/techniques/amiga/effects/083_fbm_noise
```
