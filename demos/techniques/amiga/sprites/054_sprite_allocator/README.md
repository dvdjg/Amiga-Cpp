...
```bash
tools/build/build-demo.sh demos/techniques/amiga/sprites/054_sprite_allocator --clean
tools/run/run-demo.sh       demos/techniques/amiga/sprites/054_sprite_allocator
```
