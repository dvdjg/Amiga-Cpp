...
```bash
tools/build/build-demo.sh demos/techniques/amiga/sprites/053_sprite_multiplex --clean
tools/run/run-demo.sh       demos/techniques/amiga/sprites/053_sprite_multiplex
```
