...
/// (`g_amg_run_status`). El runner resuelve ese simbolo desde el mapa/ELF y lo lee
...
extern "C" void amg_debug_ready_probe();

namespace amg::debug {

constexpr u32 run_status_magic = 0x414d4752u; // "AMGR"
