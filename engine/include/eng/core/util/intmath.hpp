...
/// \file intmath.hpp
/// Aritmética entera **sin libcalls** para los caminos calientes del engine.
///
/// El 68000 no multiplica ni divide de 32 bits en hardware: `s32 * s32` y `s32 / s32`
/// se convierten en llamadas a libgcc (`__mulsi3`, `__divsi3`, ~150 ciclos). Donde solo
/// hacen falta cocientes y razones en por mil:
///
...
///
/// Lo comparten `eng::cards` (equity, reparto de botes, pot odds) y la capa de persona de
/// `eng::sim` (probabilidades de lectura de tells).
///
...
/// llamadores usan divisores pequeños (muestras, nº de ganadores, ciegas, exposiciones).
///
