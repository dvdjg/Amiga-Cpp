...
int main() {
    ...
    // requieren contexto de display como "sin manejar" (telemetria honrada).
    {
        ...
        CopperIntent intents[3] {
            { CopperIntentKind::PaletteLine,  44,  44,  0, fake_palette, 1, 7, 0, {}, 0, nullptr },
            { CopperIntentKind::ShiftLines,  100, 100,  0,          {}, 0, 0, 4, {}, 0, nullptr },
            { CopperIntentKind::PaletteLine,  90,  90,  0, fake_palette, 0, 1, 0, {}, 0, nullptr },
        };
    ...
    // manejar"): re-pointan SPRxPT y escriben BPLCON2.
    {
        ...
        CopperIntent intents[2] {
            { CopperIntentKind::SpriteRearm, 100, 100, 0, {}, 0, 0, 0, {}, 0, sprite_data },
            { CopperIntentKind::Priority,    150, 150, 0, {}, 0, 0, 0x0040, {}, 0, nullptr },
        };
