...
| HOST-353 | [asset_table](353_asset_table/README.md) | Recursos: `AssetTable` (`eng/res/asset_table.hpp`) — tabla declarativa de assets **en memoria** por nombre + dominio (`get<PlaneTag>(...)→ByteView`), sin tamaños ni punteros en la lógica. |
