...
| HOST-340 | [chip_pool](340_block_pool/README.md) | Recursos: `BlockPool` (`eng/memory/block_pool.hpp`) — pool *first-fit* con `free`/fusión sobre un buffer (memoria reutilizable). |
