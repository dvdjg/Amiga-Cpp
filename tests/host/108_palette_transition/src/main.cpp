// ============================================================================
// Test HOST-108: efecto de transición de paleta (palette_transition.hpp).
// ============================================================================
//
...
//
//   CXX=<g++ del entorno> bash tools/run-host-tests.sh tests/host/108_palette_transition
...
int main() {
	std::printf("== HOST-108 palette_transition ==\n");
