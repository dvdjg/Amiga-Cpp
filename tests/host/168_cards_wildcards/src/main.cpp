// ============================================================================
// Test HOST-168: comodines (jokers) en baraja, evaluador y showdown
// ============================================================================
//
...
void test_wild_evaluation() {
	...
	check(hand_category(evaluate_hand(royal, 5u)) == HandCategory::StraightFlush,
	...
	check(hand_category(evaluate_hand(royal2, 5u)) == HandCategory::StraightFlush,
	...
	check(hand_category(evaluate_hand(quads, 5u)) == HandCategory::Quads,
	...
	check(hand_category(evaluate_hand(plain, 5u)) == HandCategory::StraightFlush,
	      "comodin: sin comodin no cambia");
	check(evaluate_hand(plain, 5u) == evaluate_plain(plain, 5u),
	...
	check(evaluate_hand(two, 2u) == kHandValueNone, "comodin: menos de 5 sin valor");
}
