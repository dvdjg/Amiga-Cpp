// ============================================================================
// Test HOST-109: degradado por banda (raster_gradient.hpp).
// ============================================================================
//
...
//
//   CXX=<g++ del entorno> bash tools/run-host-tests.sh tests/host/109_raster_gradient
...
int main() {
	std::printf("== HOST-109 raster_gradient ==\n");
