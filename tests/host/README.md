...
| HOST-174 | [sim_player_lod](174_sim_player_lod/README.md) | `eng/sim/lod.hpp` + `avatar.hpp`: **nivel de detalle** por distancia al jugador (realized/abstract/dormant, el dormido no cuesta), **aforo por región** (capacidad del bioma) y **jugador simulado** (intención, movimiento/comida y resumen de lo que percibe). |
