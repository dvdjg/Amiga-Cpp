...
| HOST-020 | [sintab](020_sintab/README.md) | Tabla de seno 4.12 **exacta** del original (`libmisc/sintab.c`) materializada en `eng/platform/amiga/sintab.hpp`; invariantes, simetría, checksum y uso por `math2d`. |
