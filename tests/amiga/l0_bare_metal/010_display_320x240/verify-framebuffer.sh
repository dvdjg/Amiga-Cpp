...
# Uso: tools/../tests/amiga/l0_bare_metal/010_display_320x240/verify-framebuffer.sh
...
exec node "$ROOT/dist/tests/amiga/l0_bare_metal/010_display_320x240/verify-framebuffer.js" "$@"
