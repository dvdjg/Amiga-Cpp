...
| [`300_sim_world`](300_sim_world/README.md) | build → run OK; pulido pendiente | `eng::sim`: ecosistema vivo con **LOD real (cámara)** y **planificación GOAP integrada** (`plan_tick`, caché + sufijo) |
