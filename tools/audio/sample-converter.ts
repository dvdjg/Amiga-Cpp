...
export function scaleSample(data: Uint8Array, voices: number): Uint8Array {
...
export function padToMultiple(data: Uint8Array, multiple = 4): Uint8Array {
...
export function convertSample(data: Uint8Array, voices: number): Uint8Array {
