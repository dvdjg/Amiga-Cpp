...
//
// Uso:
//   node tools/debug/verify-harness.mjs [--demo demos/techniques/amiga/playfield/202_xlimited_dpf] [--min-fps 45] [--build]
//
// Asserts:
...
const demo = arg('--demo', 'demos/techniques/amiga/playfield/202_xlimited_dpf');
