...
const ROWS = [
  ...
  { fn: 'min / max / abs / sign',    flt: 'si', mf: 'si', fx: 'si', test: 'HOST-062' },
  { fn: 'move_towards',              flt: 'si', mf: 'si', fx: 'si', test: 'HOST-062' },
  { fn: 'deadzone',                  flt: 'si', mf: 'si', fx: 'si', test: 'HOST-062' },
  { fn: 'smooth_damp',               flt: 'si', mf: 'si', fx: '— (sin exp2)', test: 'HOST-062' },
  { fn: 'repeat / pingpong',         flt: 'si', mf: 'si', fx: 'si (div_norm)', test: 'HOST-062' },
  { fn: 'ease_in/out/in_out_back',   flt: 'si', mf: 'si', fx: 'si', test: 'HOST-062' },
  { fn: 'bezier2 / bezier3',         flt: 'si', mf: 'si', fx: 'si', test: 'HOST-062' },
  { fn: 'bezier2 / bezier3 (Vec<N>)', flt: 'si', mf: 'si', fx: 'si', test: 'HOST-062' },
