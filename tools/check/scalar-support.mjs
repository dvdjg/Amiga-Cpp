...
// math-diagnostics). `fx` es `Fixed<s16,E>` (4.12 en retro) y `f32` es `Fixed<s32,E>`
// (host/68020; en m68k esta vetado por libcalls de 64 bits). La misma maquinaria generica
// sirve a los dos anchos: cambia la representacion (mas rango), no el algoritmo.
const ROWS = [
  { fn: 'clamp / saturate / step',   flt: 'si', mf: 'si', fx: 'si', f32: 'si', test: 'HOST-059' },
  { fn: 'lerp',                      flt: 'si', mf: 'si (pierde incremento si |b-a| < |a|/2048)', fx: 'si', f32: 'si', test: 'HOST-059' },
  { fn: 'smoothstep',                flt: 'si', mf: 'si', fx: 'si', f32: 'si', test: 'HOST-059' },
  { fn: 'smootherstep',              flt: 'si', mf: 'si', fx: 'no (coef 15 > rango ±8)', f32: 'si (32 bits dan rango)', test: 'HOST-135 / math-diag smootherstep_q12_range' },
  { fn: 'inv_lerp / remap',          flt: 'si', mf: 'si', fx: 'si (div_norm)', f32: 'si (div_norm)', test: 'HOST-059' },
  ...
  { fn: 'smooth_damp',               flt: 'si', mf: 'si', fx: 'si (fixed_math, exp2)', f32: 'si (fixed_math, exp2)', test: 'HOST-065/104' },
  { fn: 'repeat / pingpong',         flt: 'si', mf: 'si', fx: 'si (div_norm)', f32: 'si (div_norm)', test: 'HOST-065' },
  { fn: 'ease_in/out/in_out_back',   flt: 'si', mf: 'si', fx: 'si', f32: 'si', test: 'HOST-065' },
  { fn: 'bezier2 / bezier3',         flt: 'si', mf: 'si', fx: 'si', f32: 'si', test: 'HOST-065' },
  { fn: 'bezier2 / bezier3 (Vec<N>)', flt: 'si', mf: 'si', fx: 'si', f32: 'si', test: 'HOST-065' },
  { fn: 'wrap_angle / angle_diff',   flt: '—', mf: 'si', fx: 'si (fixed_math)', f32: 'si (fixed_math)', test: 'HOST-057/104' },
  { fn: 'sqrt / sin / cos / exp2 / log2', flt: '—', mf: 'si', fx: 'si (fixed_math)', f32: 'si (fixed_math)', test: 'HOST-057/104' },
  { fn: 'exp / log / pow',            flt: '—', mf: 'si (minifloat_math)', fx: 'si (fixed_math)', f32: 'si (fixed_math)', test: 'HOST-104' },
  { fn: 'tan / asin / acos / atan2',  flt: 'solo atan2', mf: 'si', fx: 'si (fixed_math)', f32: 'si (fixed_math)', test: 'HOST-057/104' },
  { fn: 'sincos (una pasada)',       flt: 'si', mf: 'si (minifloat_math)', fx: 'si (fixed_math)', f32: 'si (fixed_math)', test: 'HOST-057/104' },
  { fn: 'angle_of / from_angle / angle_to (apuntado)', flt: 'si', mf: 'si', fx: 'si (fixed_math)', f32: 'si (fixed_math)', test: 'HOST-059/104' },
  { fn: 'transform (MF × fix)',      flt: '—', mf: 'ratio MF (|m| <= 8)', fx: 'coordenada', f32: 'coordenada', test: 'HOST-058' },
  { fn: 'stats::mean / variance / stddev', flt: 'si', mf: 'si', fx: 'si (sum/mean con acumulador s32; stddev con fixed_math)', f32: 'si', test: 'HOST-093/104' },
  { fn: 'dsp::Adsr / OnePole / DelayLine / osc_*', flt: 'si', mf: 'si', fx: 'si (osc_sine con fixed_math)', f32: 'si', test: 'HOST-102/104' },
];
...
function renderTable() {
  ...
  for (const r of ROWS) {
    lines.push(`| ${r.fn} | ${r.flt} | ${r.mf} | ${r.fx} | ${r.f32} | ${r.test} |`);
  }
  return lines.join('\n');
}
