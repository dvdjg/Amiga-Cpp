...
const ROWS = [
  ...
  { fn: 'length / normalize / reflect / project', flt: 'si', mf: 'si (limites de rango)', fx: 'length si (fixed_math); normalize/project no (division)', test: 'HOST-059/104' },
  ...
  { fn: 'ease_in/out/in_out_sine/_expo', flt: 'si', mf: 'si (necesita sin/cos/exp2)', fx: 'si _sine (fixed_math); _expo no (sin exp2)', test: 'HOST-064/104' },
  ...
  { fn: 'smooth_damp',               flt: 'si', mf: 'si', fx: '— (sin exp2)', test: 'HOST-065' },
  ...
  { fn: 'sqrt/exp/log/sin/cos/tan',  flt: '—', mf: 'si', fx: 'sqrt/sin/cos si (fixed_math); exp/log/tan no', test: 'HOST-057/104' },
  ...
  { fn: 'dsp::Adsr / OnePole / DelayLine / osc_*', flt: 'si', mf: 'si', fx: 'si (salvo osc_sine)', test: 'HOST-102' },
];
