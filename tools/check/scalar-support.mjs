...
const ROWS = [
  ...
  { fn: 'tan / asin / acos / atan2',  flt: 'solo atan2', mf: 'si', fx: 'si (fixed_math)', test: 'HOST-057/104' },
  { fn: 'sincos (una pasada)',       flt: 'si', mf: 'si (minifloat_math)', fx: 'si (fixed_math)', test: 'HOST-057/104' },
  { fn: 'angle_of / from_angle / angle_to (apuntado)', flt: 'si', mf: 'si', fx: 'si (fixed_math)', test: 'HOST-059/104' },
