...
- Windows + Bash + Node.js son obligatorios para el flujo de ejecución automatizada (`tools/run/run-demo.sh` -> `dist/tools/run/run-demo.js`). PowerShell solo se usa cuando el script o la integración con Visual Studio lo exige.
