...
- **API pública (la aplicación no ve hardware)**: `docs/engine/architecture/PUBLIC_API.md` — la app describe capas/cámaras/efectos y el planner deduce la composición; tipos fuertes, handles, errores sin excepciones, init/frame.
